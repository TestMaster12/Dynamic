...
do
  ...
  return {
    ...
    usage = {
      user = {
        '!id: will show your id and group id .'
      },
      moderator = {
        '!id : will give you the id of member or yourself',
        '!chatid : the ids of chat',
        '!info chat txt : will give the ids of chat in text file',
        '!id chat pm : will give chat ids in Private ',
        '!info chat p : will give chat ids in text file to your privat',
        '!info <id> : will shot the ids of chat group',
        '!res @<user_name> : will return the info of username ',
